...
public class Converter extends JFrame implements ActionListener 
{
    ...
    public static void main(String []args)
    {
        ...
        Timer timer = new Timer(20 ,ticktock); //timer is ticking
    ...
    public Converter(String t)
    {
        ...
        //set fonts
        Font ft1 = new Font("Kanit",Font.PLAIN,14);
        Font ft2 = new Font("Lucida Handwriting",Font.BOLD,18);
